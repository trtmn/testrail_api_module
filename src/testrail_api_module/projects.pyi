...
class ProjectsAPI(BaseAPI):
    ...
    def get_projects(self) -> list[dict[str, Any]] | None:
        ...
        """
    def add_project(self, name: str, announcement: str | None = None, show_announcement: bool = False, is_completed: bool = False) -> dict[str, Any] | None:
        """
        Add a new project.
    ...
    def get_project_stats(self, project_id: int) -> dict[str, Any] | None:
        ...
        """
    def get_project_activity(self, project_id: int) -> list[dict[str, Any]] | None:
        """
        ...
        """
    def get_project_attachments(self, project_id: int) -> list[dict[str, Any]] | None:
        """
        ...
        """
    def add_project_attachment(self, project_id: int, file_path: str, description: str | None = None) -> dict[str, Any] | None:
        """
