...
class GroupsAPI(BaseAPI):
    ...
    def get_groups(self, project_id: int) -> list[dict[str, Any]]:
        ...
        '''
    def add_group(self, project_id: int, name: str, description: str | None = None) -> dict[str, Any]:
        '''
        Add a new group.
        ...
        Example:
            ...
            ... )
        '''
    def update_group(self, group_id: int, name: str | None = None, description: str | None = None) -> dict[str, Any]:
        '''
        Update a group.
