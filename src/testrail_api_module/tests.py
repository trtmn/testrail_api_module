...
class TestsAPI(BaseAPI):
    ...
    def get_test(self, test_id: int,
                 with_data: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
        Get a test by ID.
    ...
    def get_tests(self,
                  run_id: int,
                  status_id: Optional[Union[int,
                                            List[int]]] = None,
                  limit: Optional[int] = None,
                  offset: Optional[int] = None,
                  label_id: Optional[Union[int,
                                           List[int]]] = None) -> Optional[List[Dict[str,
                                                                           Any]]]:
        """
        ...
        if label_id is not None:
            # Convert list to comma-separated string if needed
            params['label_id'] = ','.join(map(str, label_id)) if isinstance(
                label_id, list) else label_id
    ...
    def add_test_result(self,
        ...
        return self._api_request(
            'POST', f'add_result_for_test/{test_id}', data=data)

    def add_test_results(self,
                         test_ids: List[int],
                         results: List[Dict[str,
                                            Any]]) -> Optional[List[Dict[str,
                                                                         Any]]]:
        """
