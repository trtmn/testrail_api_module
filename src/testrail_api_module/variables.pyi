...
class VariablesAPI(BaseAPI):
    ...
    def get_variables(self, project_id: int) -> list[dict[str, Any]] | None:
        ...
        """
    def add_variable(self, project_id: int, name: str, value: str, description: str | None = None) -> dict[str, Any] | None:
        """
        Add a new variable.
    ...
    def delete_variable(self, variable_id: int) -> dict[str, Any] | None:
        ...
        """
    def get_variable_groups(self, project_id: int) -> list[dict[str, Any]] | None:
        """
        ...
        """
    def add_variable_group(self, project_id: int, name: str, description: str | None = None) -> dict[str, Any] | None:
        """
