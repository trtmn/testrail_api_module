...
class RunsAPI(BaseAPI):
    ...
    def get_run(self, run_id: int) -> dict[str, Any]:
        ...
        '''
    def get_runs(self, project_id: int, suite_id: int | None = None, created_after: int | None = None, created_before: int | None = None, created_by: int | None = None, is_completed: bool | None = None, limit: int | None = None, offset: int | None = None) -> list[dict[str, Any]]:
        '''
        ...
        Example:
            ...
            ...     print(f"Run: {run[\'name\']}")
        '''
    def add_run(self, project_id: int, name: str, description: str | None = None, suite_id: int | None = None, milestone_id: int | None = None, assignedto_id: int | None = None, include_all: bool = True, case_ids: list[int] | None = None) -> dict[str, Any]:
        '''
        Add a new test run.
        ...
        Example:
            ...
            ... )
        '''
    def update_run(self, run_id: int, name: str | None = None, description: str | None = None, milestone_id: int | None = None, assignedto_id: int | None = None) -> dict[str, Any]:
        '''
        Update a test run.
