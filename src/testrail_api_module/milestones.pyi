...
class MilestonesAPI(BaseAPI):
    ...
    def get_milestones(self, project_id: int) -> list[dict[str, Any]] | None:
        ...
        """
    def add_milestone(self, project_id: int, name: str, description: str | None = None, due_on: str | None = None, parent_id: int | None = None, start_on: str | None = None) -> dict[str, Any] | None:
        """
        Add a new milestone.
