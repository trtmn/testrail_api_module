...
class ResultsAPI(BaseAPI):
    ...
    def add_result_for_run(self, run_id: int, status_id: int, comment: str | None = None, version: str | None = None, elapsed: str | None = None, defects: str | None = None, assignedto_id: int | None = None, custom_fields: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        Example:
            ...
            ... )
        '''
    def get_results(self, run_id: int, status_id: int | list[int] | None = None, created_after: int | None = None, created_before: int | None = None, created_by: int | list[int] | None = None, defects_filter: str | None = None, limit: int | None = None, offset: int | None = None) -> list[dict[str, Any]]:
        '''
    ...
    def get_results_for_case(self, run_id: int, case_id: int) -> list[dict[str, Any]]:
        ...
        '''
    def get_results_for_run(self, run_id: int, status_id: int | list[int] | None = None, created_after: int | None = None, created_before: int | None = None, created_by: int | list[int] | None = None, defects_filter: str | None = None, limit: int | None = None, offset: int | None = None) -> list[dict[str, Any]]:
        """
        Get all test results for a test run.
