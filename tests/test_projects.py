...
class TestProjectsAPI:
    ...
    def test_add_project_attachment(self, projects_api: ProjectsAPI) -> None:
        ...
        with patch.object(projects_api, "_api_request") as mock_request:
            ...
            projects_api.add_project_attachment(
                project_id=1,
            ...
            mock_request.assert_called_once_with(
                "POST", "add_project_attachment/1", data=expected_data
            )

    def test_add_project_attachment_without_description(
        self, projects_api: ProjectsAPI
    ) -> None:
        ...
        with patch.object(projects_api, "_api_request") as mock_request:
            ...
            projects_api.add_project_attachment(
                project_id=1, file_path="/path/to/file.txt", description=None
            )
