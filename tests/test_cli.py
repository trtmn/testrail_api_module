...
class TestSetupLogging:
    ...
    def test_setup_logging_verbose_mode(self) -> None:
        ...
        # Logger should be able to log debug messages (effective level should be DEBUG)
    ...
    def test_setup_logging_no_debug(self) -> None:
        ...
        # but we do not globally disable logging (so tests/apps can re-enable it).
...
class TestDebugEnvironmentVariable:
    ...
    def test_debug_enabled_values(self, value: str, monkeypatch: 'MonkeyPatch') -> None:
    ...
    def test_debug_disabled_values(self, value: str, monkeypatch: 'MonkeyPatch') -> None:
