...
class TestTestsAPI:
    ...
    def test_get_test_minimal(self, tests_api: TestsAPI) -> None:
        ...
        with patch.object(tests_api, "_get") as mock_get:
            ...
            result = result = tests_api.get_test(test_id=1)
    ...
    def test_get_test_with_data(self, tests_api: TestsAPI) -> None:
        ...
        with patch.object(tests_api, "_get") as mock_get:
            ...
            tests_api.get_test(test_id=1, with_data=1)

            expected_params = {"with_data": 1}
            mock_get.assert_called_once_with(
                "get_test/1", params=expected_params
            )
    ...
    def test_get_tests_with_single_status_id(
        ...
        with patch.object(tests_api, "_get") as mock_get:
            ...
            tests_api.get_tests(run_id=1, status_id=1)
    ...
    def test_get_tests_with_list_status_id(self, tests_api: TestsAPI) -> None:
        ...
        with patch.object(tests_api, "_get") as mock_get:
            ...
            tests_api.get_tests(run_id=1, status_id=[1, 5])
    ...
    def test_add_test_result_minimal(self, tests_api: TestsAPI) -> None:
        ...
        with patch.object(tests_api, "_api_request") as mock_request:
            ...
            mock_request.assert_called_once_with(
                "POST", "add_result_for_test/1", data=expected_data
            )
            assert result == {"id": 1, "status_id": 1}

    def test_add_test_result_with_all_parameters(
        self, tests_api: TestsAPI
    ) -> None:
    ...
    def test_add_test_result_with_none_values(
        self, tests_api: TestsAPI
    ) -> None:
    ...
    def test_add_test_results(self, tests_api: TestsAPI) -> None:
        ...
        with patch.object(tests_api, "_api_request") as mock_request:
            ...
            tests_api.add_test_results(test_ids=test_ids, results=results)

            expected_data = {"test_ids": test_ids, "results": results}
            mock_request.assert_called_once_with(
                "POST", "add_results_for_tests", data=expected_data
            )
