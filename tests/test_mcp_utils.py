...
class TestGenerateToolName:
    ...
    def test_handles_different_modules(self):
        ...
        assert generate_tool_name('results', 'add_result') == 'testrail_results_add_result'
        assert generate_tool_name('runs', 'get_runs') == 'testrail_runs_get_runs'
        assert generate_tool_name('projects', 'get_project') == 'testrail_projects_get_project'
